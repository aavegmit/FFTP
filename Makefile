...
server: server.o server_tcp.o server_udp.o fileIO.o shared.o cache.o
	g++ -o server server.o server_tcp.o server_udp.o shared.o fileIO.o cache.o -Wall -D_REETRANT -lpthread
